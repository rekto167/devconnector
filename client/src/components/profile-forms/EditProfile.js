...
const EditProfile = ({profile: {profile, loading}, getCurrentProfile, createProfile, history}) => {
    ...
    return (
        ...
        <form className="form" onSubmit={e => onSubmit(e)} >
            ...
            <div className="my-2">
            <button onClick={() => toggledSocialInput(!displaySocialInputs)} type="button" className="btn btn-light">
            ...
            {displaySocialInputs && (
                <Fragment>
                    ...
                    <FontAwesomeIcon icon={faTwitter} size="2x" className="text-primary" />
